...
// Mouse Movement Parallax for Background Orbs
...
(function initTheme() {
  ...
  function setTheme(theme) {
    ...
    localStorage.setItem('template3-theme', theme);
  }

  // Load saved theme or default to dark
  const savedTheme = localStorage.getItem('template3-theme') || 'dark';
  setTheme(savedTheme);
...
(function hydratePortfolio() {
  ...
  if (nameEl && data.name) {
    ...
    document.title = `${data.name} | Specs`;
